...
Our hypothesis is that the color that a color is written in will affect how long
...
and the color it is written in matching would make the task take less time, it
...
fewer seconds to complete the stroop task when the colors are congruent.
