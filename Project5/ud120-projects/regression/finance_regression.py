...
# A way to confirm that you’re right in this hypothesis is to regress 
# the bonus against the long term incentive, and see if the regression 
...
pred2 = reg2.predict(feature_test2)

reg2.score(feature_test2, target_test2)
